...
const (
	...
	TrxService_ConfirmTrxByPassServ_FullMethodName      = "/trx.TrxService/ConfirmTrxByPassServ"
...
type TrxServiceClient interface {
	...
	ConfirmTrxByPassServ(ctx context.Context, in *ConfirmTrxByPass, opts ...grpc.CallOption) (*Response, error)
...
func (c *trxServiceClient) ConfirmTrxByPassServ(ctx context.Context, in *ConfirmTrxByPass, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, TrxService_ConfirmTrxByPassServ_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TrxServiceServer interface {
	...
	ConfirmTrxByPassServ(context.Context, *ConfirmTrxByPass) (*Response, error)
...
func (UnimplementedTrxServiceServer) ConfirmTrxByPassServ(context.Context, *ConfirmTrxByPass) (*Response, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ConfirmTrxByPassServ not implemented")
}
...
func _TrxService_ConfirmTrxByPassServ_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ConfirmTrxByPass)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TrxServiceServer).ConfirmTrxByPassServ(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TrxService_ConfirmTrxByPassServ_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TrxServiceServer).ConfirmTrxByPassServ(ctx, req.(*ConfirmTrxByPass))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TrxService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ConfirmTrxByPassServ",
			Handler:    _TrxService_ConfirmTrxByPassServ_Handler,
		},
		{
